...
// -> hxs-add-setScrollView: headerHeight:
- (void)setScrollView:(UIScrollView *)scrollView insetY:(CGFloat)y
{
    [super setScrollView:scrollView];
    
    // 1.设置边框
    self.frame = CGRectMake(0, - MJRefreshViewHeight - y, scrollView.frame.size.width, MJRefreshViewHeight);
