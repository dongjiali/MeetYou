...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        UIImageView *loadingImageView = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"地图" ofType:@"png"]]];
        [loadingImageView setWidth:58.0f];
        [loadingImageView setHeight:58.0f];
        loadingImageView.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        [self addSubview:_loadingImageView = loadingImageView];
        
        UIImageView *planeImageView = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"小飞机" ofType:@"png"]]];
        [planeImageView setWidth:58.0f];
        [planeImageView setHeight:58.0f];
        planeImageView.autoresizesSubviews = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        [self addSubview:_planeImageView = planeImageView];
...
- (void)setFrame:(CGRect)frame
{
    ...
    // -> hxs add 14.06.03
    // 5.加载图片
    _loadingImageView.center = CGPointMake(w * 0.5f, h * 0.5f);
    
    // 6.飞机图片
    _planeImageView.center = _loadingImageView.center;
    // <-
}
...
- (void)stopRotateLoadingImage {
    [_loadingImageView.layer removeAllAnimations];
    [_loadingImageView setImage:[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"地图" ofType:@"png"]]];
}
// <-
